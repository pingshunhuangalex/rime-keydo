...
- 尽可能使相同结构的词拥有相同的编码长度（优先对应并分配在首个形码的编码位置）
  ...
  - 词组如能同时与`长`与`久`搭配，则确保相应词组顺序为`长`，然后才是`久`
  - 词组如能同时与`大`、`多`与`低`搭配，则确保相应词组顺序为`大`，`多`，最后才是`低`
  ...
  - 词组如能同时与`疼`与`痛`搭配，则确保相应词组顺序为`疼`，然后才是`痛`
  - 词组如能同时与`有`与`一`搭配，则确保相应词组顺序为`有`，然后才是`一`
  - 词组如能同时与`想`、`像`与`香`搭配，则确保相应词组顺序为`想`，`像`，最后才是`香`
